...
> Built for **Griffin Linux aka Griffin OS** — soon to be available for everyone. ![Appify Screenshot](https://github.com/bobbycomet/Appify/blob/main/Extensionsview.png)
